...
public class EnrollmentStudent {
    ...
    public EnrollmentStudent(int blockId, String blockCode, String blockName, String blockSemester, Date blockStartDate, Date blockEndDate, int courseId, String courseCode, String courseName, String courseDescription, int facultyId, String falcultyTitle, int sectionId, String studentFirstName, String studentLastName, int studentId) {
